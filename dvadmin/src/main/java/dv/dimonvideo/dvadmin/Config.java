...
public class Config {
    ...
    public static final String HOST_URL = "https://api.dimonvideo.ru";
    public static final String COUNT_URL = HOST_URL + "/smart/dvadminapi.php?op=18";
    public static final String ADMIN_URL = BASE_URL + "/logs";
    public static final String UPL_URL = BASE_URL + "/logs/uploader/0";
    public static final String TAG = "DVAdmin";
